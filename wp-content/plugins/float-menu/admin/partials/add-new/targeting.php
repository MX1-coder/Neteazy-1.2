...
<div id="targeting" class="postbox wow-sidebar">
    ...
    <div class="inside">
        <div class="container">
            <div class="element">
				...
				<?php echo self::option( $include_more_screen ); ?> <label
                        for="include_more_screen"><?php esc_html_e( "Don't show on screens more", $this->plugin['text'] ); ?></label><?php echo self::tooltip( $show_screen_help ); ?>
                <p/>
				<?php echo self::option( $screen_more ); ?>
				<?php echo self::option( $include_mobile ); ?> <label
                        for="include_mobile"><?php esc_html_e( "Don't show on screens less", $this->plugin['text'] ); ?></label><?php echo self::tooltip( $include_mobile_help ); ?>
                <p/>
        ...
        <div class="container">
            <div class="element">
                <h4><?php esc_html_e( 'Show for users', $this->plugin['text'] ); ?><?php echo self::pro(); ?></h4>
        ...
        <div class="container">
            <div class="element">
                <h4><?php esc_html_e( 'Depending on the language', $this->plugin['text'] ); ?><?php echo self::pro(); ?></h4>
                <input type="checkbox" disabled id="depending_language"> <label
                        for="depending_language"><?php esc_html_e( "Enable", $this->plugin['text'] ); ?></label>
                <p/>
            </div>
        </div>
        <div class="container">
        ...
        <div class="container">
            <div class="element">
                <p/>
                <h4><?php esc_html_e( 'Mobile Rules', $this->plugin['text'] ); ?></h4>
				<?php echo self::option( $mobile_rules ); ?>
                <label for="mobile_rules"> <?php esc_html_e( 'Enable', $this->plugin['text'] ); ?></label>
				<?php echo self::tooltip( $mobile_rules_help ); ?>
                <p/>
                <span id="mobile_screen_block">
					<?php esc_html_e( 'Mobile screen ', $this->plugin['text'] ); ?> (px) <?php echo self::tooltip( $mobile_screen_help ); ?>
